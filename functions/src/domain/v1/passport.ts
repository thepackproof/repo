...
export const PASSPORT_PDF_RENDERER_VERSION = 'packproof-passport-pdf@1.0.0' as const;
...
export type PassportCommerceInput = {
  ...
  trustLevel: 'MERCHANT_SERVER_ATTESTED' | 'PLATFORM_API_ATTESTED' | 'PAGE_DECLARED' | null;
  assertingSource: string | null;
  externalOrderId: string | null;
...
function evaluateIntegrity(input: PassportAggregatorInput, displayedUnattributed: number): PassportIntegrity {
