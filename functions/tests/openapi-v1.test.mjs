...
test('OpenAPI v1 contract is parseable, versioned, and operation-complete', async () => {
  ...
  assert.deepEqual(Object.keys(contract.paths).sort(), [
    ...
    '/v1/portal/transactions/{transactionId}/passport/identity',
    '/v1/portal/transactions/{transactionId}/proof',
    '/v1/portal/transactions/{transactionId}/proof/identity',
    ...
    '/v1/transactions/{transactionId}/passport/identity',
    '/v1/transactions/{transactionId}/passport/snapshots',
    '/v1/transactions/{transactionId}/proof',
    '/v1/transactions/{transactionId}/proof/identity',
    ...
    '/v1/transactions/{transactionId}/workspace',
  ]);
  const operations = [];
  ...
  assert.deepEqual(operations.sort(), [
    ...
    'issuePortalPassportIdentity',
    'issuePortalProofIdentity',
    'issueProofIdentity',
    'listConnectSessions',
    'listEvidence',
    'listPortalEvidence',
