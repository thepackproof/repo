...
export const APP_BOUNDARY =
  'This panel renders the live Proof JSON from PackProof API. It does not assemble a Proof, authenticate an item, prove custody, decide fraud or fault, or determine a Zendesk, card-network, carrier, marketplace, or payment outcome.';
...
export function projectLookup(result) {
  ...
  if (result.type === 'ambiguous') {
    return {
      ...
      message: 'Choose the PackProof transaction that belongs to this ticket. PackProof does not infer which record is the claim.',
