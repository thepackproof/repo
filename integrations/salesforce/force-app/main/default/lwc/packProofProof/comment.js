import { APP_BOUNDARY, COMPARISON_FOOTNOTE } from './passportView';

/**
 * Internal Salesforce Case note. It organizes recorded facts; it does not recommend a disposition.
 * @param {ReturnType<import('./passportView.js').projectPassport>} view
 * @returns {string}
 */
