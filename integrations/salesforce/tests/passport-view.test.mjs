...
import { internalNoteBody } from '../force-app/main/default/lwc/packProofProof/comment.js';
import { APP_BOUNDARY, projectLookup, projectPassport } from '../force-app/main/default/lwc/packProofProof/passportView.js';
