...
The original-hash snapshot binds digital source records; it does not by itself show that the same physical item was returned. Version 0.8.5.0 reports physical correspondence as `NOT_AVAILABLE`.
