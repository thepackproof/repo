...
| [0016](0016-zendesk-claims-presentation-surface.md) | Zendesk Support is a claims-review presentation surface over PackProof API / Connect; merchant keys stay in Zendesk secure settings | Accepted |
| [0017](0017-salesforce-claims-presentation-surface.md) | Salesforce Service Cloud is a claims-review presentation surface over PackProof API / Connect; merchant keys stay in Named Credentials | Accepted |
