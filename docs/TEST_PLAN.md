...
| AUTO-17 | Proof presentation parity | Mobile, portal, and PDF snapshots share Proof ID, transaction, hashes, timestamps, provenance fields, and disclaimers from one canonical object; viewers import `presentProof` |
