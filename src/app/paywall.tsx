...
export default function Paywall() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.container}>
    ...
    <View style={styles.star}><AppIcon name="checkmark.shield.fill" size={42} tintColor={colors.teal} /></View>
    ...
    <Card style={styles.features}>
      {['Unlimited active transaction passports', 'Google Play purchase management', 'Purchase restoration on supported Android builds'].map((feature) => <View key={feature} style={styles.feature}><AppIcon name="checkmark.circle.fill" size={19} tintColor={colors.teal} /><Text style={styles.featureText}>{feature}</Text></View>)}
    </Card>
