...
export default function TransactionDetail() {
  ...
  const actions = <View style={styles.actions}>
    ...
    {!['DRAFT', 'CANCELLED', 'ARCHIVED'].includes(item.status) ? <Button label="Open PackProof Passport" icon="checkmark.shield.fill" variant="secondary" onPress={() => router.push(`/passport/${id}`)} /> : null}
